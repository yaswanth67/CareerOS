  ...
  const sampleJobs = [
    {
      ...
      salaryMax: 180000,
      currency: 'USD',
      applyUrl: 'https://careers.google.com/jobs/results/123',
    ...
    },
    {
      ...
      salaryMax: 250000,
      currency: 'USD',
      applyUrl: 'https://openai.com/careers/456',
    ...
    },
    {
      ...
      salaryMax: 200000,
      currency: 'USD',
      applyUrl: 'https://stripe.com/jobs/789',
    ...
    },
    {
      ...
      salaryMax: 220000,
      currency: 'USD',
      applyUrl: 'https://vercel.com/careers/101',
    ...
    },
    {
      ...
      salaryMax: 200000,
      currency: 'USD',
      applyUrl: 'https://www.metacareers.com/jobs/202',
    ...
    },
    {
      ...
      salaryMax: 400000,
      currency: 'USD',
      applyUrl: 'https://anthropic.com/careers/303',
    ...
    },
    {
      ...
      salaryMax: 250000,
      currency: 'USD',
      applyUrl: 'https://jobs.netflix.com/jobs/404',
