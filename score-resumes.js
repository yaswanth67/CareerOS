// Standalone script to score all resumes
const { PrismaClient } = require('@prisma/client')
const { parseJsonArray, stringifyJsonArray } = require('./src/lib/utils')

const prisma = new PrismaClient()

// Heuristic scoring function (copied from ai-matcher/index.ts)
const TECH_SKILLS = [
  // Languages
